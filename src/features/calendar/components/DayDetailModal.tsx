...
export function DayDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-[var(--z-index-modal-backdrop)] flex items-end justify-center bg-black/40 px-4 pb-4 pt-10 sm:items-center sm:p-6">
      <div className="z-[var(--z-index-modal)] max-h-full w-full max-w-md overflow-y-auto rounded-2xl bg-white p-4 shadow-xl">
